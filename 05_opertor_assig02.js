...
function maleMarriageEligbility(gender,age,boyName) {
    var result = gender== "male" && age>=21 ? `Hey ${boyName} you are eligible for marriage` : `"${boyName}No try next time "`;
    return result;
}
...
console.log(`=====================step 2====================`);
 function femaleMarriageEligibility(gender,age,girName) {
    var femaleresult = gender =="female" && age>=18 ? `hey ${girName} you are eligible for marriage` : `"${girName} no try next time"`;
    return femaleresult;
