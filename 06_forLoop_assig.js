console.log(`WAP to print number from 5 to 15 by increment 1`);
for (let index = 5; index <=15; index++) {
    console.log(index);
    
}
console.log(`WAP to print number from 50 t 40 by decrement by 1`);
...
console.log(`WAP to print first 10 even number`);
